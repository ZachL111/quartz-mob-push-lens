"""Regression checks for the quartz-mob-push-lens casebook."""
...
from casebook.harness import assert_expected, quartz_mob_push_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(quartz_mob_push_lens_summary(), assert_expected())
